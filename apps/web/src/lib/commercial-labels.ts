...
const PROVIDER_LABELS: Record<string, string> = {
  ...
  receita: 'Fonte oficial empresarial',
  receita_federal: 'Fonte oficial empresarial',
  receita_qsa: 'Fonte oficial empresarial',
  cnpj_receita: 'Fonte oficial empresarial',
  brasilapi: 'Dados cadastrais',
  minhareceita: 'Dados cadastrais',
  cnpja: 'Dados cadastrais',
  cnpj: 'Dados cadastrais',
  duckduckgo: 'Busca pública',
  bing: 'Busca pública',
  google_search: 'Busca pública',
  search: 'Busca pública',
  'search:duckduckgo': 'Busca pública',
  'search:bing': 'Busca pública',
  'search:cached': 'Busca pública',
  heuristic: 'Padrão observado (não confirmado)',
  csv_import: 'Planilha importada',
