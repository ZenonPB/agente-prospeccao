...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Encontrar novos clientes começa por uma busca',
  ...
  },
  {
    ...
    description: 'Clique em “Nova busca” e escreva algo como “quero vender landing pages para clínicas de psicologia de Araraquara” ou “quero encontrar eventos de empresa júnior que possam precisar de troféus”. O sistema transforma a frase em uma estratégia para você revisar.',
    popoverSide: 'bottom', popoverAlign: 'start',
  },
  {
    ...
    description: 'Os cartões mostram o andamento de cada busca. Abra uma busca para entender o que foi encontrado, revisar a qualidade e decidir se vale continuar, ajustar ou pausar.',
    popoverSide: 'bottom', popoverAlign: 'center',
  },
  {
    ...
    description: 'Se já existir uma busca, esta tela mostra como os leads percorrem a pesquisa e a análise. A nota nunca deve ser lida sozinha: abra o lead e confira os motivos e evidências que justificam a recomendação.',
    popoverSide: 'bottom', popoverAlign: 'center',
  },
  {
  ...
  },
  {
    ...
    title: 'Próximos contatos sem depender da memória',
  ...
  },
  {
    ...
    title: 'O que está funcionando passa por pessoas',
    description: 'Avaliações e resultados reais podem sugerir ajustes, mas o sistema não muda a forma de pontuar sozinho. A gestão revisa evidências, aprova uma versão e pode voltar para a anterior se necessário.',
    analystOnly: true,
  },
  {
    id: 'radar', chapter: 'Melhorando', targetRoute: '/monitoramento', elementSelector: null,
    title: 'Novidades que merecem atenção',
  ...
  },
  {
    ...
    title: 'Integrações',
    description: 'Conexões com outros sistemas ficam separadas por organização. Só habilite o que a equipe realmente usa e valide a conexão antes de depender dela na operação.',
    analystOnly: true,
  },
  {
    ...
    description: 'Configurações pessoais, equipe, limites e comportamento da operação ficam aqui. O que aparece para você depende do seu papel na organização.',
    popoverSide: 'bottom', popoverAlign: 'start',
  },
  {
