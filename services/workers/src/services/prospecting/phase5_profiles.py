    ...
    profiles = [
        OfferProfile(
            ...
            icp={
                ...
                "segments": ["serviços", "indústria", "distribuição", "operações multiunidade"],
                "exclusions": ["negócio sem processo recorrente"],
            },
            discovery={
                "providers": ["google_places", "cnae_discovery", "job_search"],
                "target_candidates": 250,
                "query_strategy": "segment+operations+city",
            },
            prescoring={
                "weights": {
                    "MULTI_UNIT": 18,
            ...
            decision_makers={
                "roles": ["founder", "operations_director", "finance_manager", "it_manager"],
            ...
            qualification={
                "questions": [
                    "Qual processo hoje exige mais trabalho manual?",
                    "Quais ferramentas precisam trocar dados entre si?",
        ...
        OfferProfile(
            ...
            enrichment={"steps": ["cnpj_receita", "business_social"], "max_cost": 3, "people_discovery": {"max_cost": 2, "max_steps": 2, "min_role_fit": 65}},
        ...
        OfferProfile(
            ...
            enrichment={"steps": ["business_social"], "max_cost": 3, "people_discovery": {"max_cost": 2, "max_steps": 2, "min_role_fit": 60}},
