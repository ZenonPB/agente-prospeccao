"""Modelos persistentes para excelência por oferta e automação contínua.

Mantidos no domínio de workers, que continua sendo o dono do schema.
"""
...
class SavedProspectingSearch(Base):
    ...
    __table_args__ = (
        Index("ix_saved_searches_org_enabled", "organization_id", "enabled"),
    )
...
class CaseStudy(Base):
    ...
    __table_args__ = (
        Index("ix_case_studies_org_offer_active", "organization_id", "offer_key", "active"),
    )
