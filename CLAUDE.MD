...
1. Corrigir bug do filtro de duplicata no `main.py`
2. Trocar `print` por `logging` em `main.py` e `places_service.py`
3. Mover `httpx.AsyncClient` do `__init__` para `async with` em `technical_enrichment_service.py`